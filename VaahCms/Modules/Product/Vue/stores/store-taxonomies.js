...
let model_namespace = 'VaahCms\\Modules\\Product\\Models\\Taxnonmy';
...
export const useTaxnonmyStore = defineStore({
    id: 'taxonomies',
    state: () => ({
        page: 1,
        rows: 20,
    ...
    actions: {
        ...
        async selectType(event) {
            this.item.vh_taxonmies_shivang_id = event.id;
...
// Pinia hot reload
if (import.meta.hot) {
    import.meta.hot.accept(acceptHMRUpdate(useTaxnonmyStore, import.meta.hot))
}
