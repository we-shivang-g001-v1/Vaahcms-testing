...
use VaahCms\Modules\Product\Models\Taxnonmy;
...
class TaxonomiesController extends Controller
{
  ...
  public function getList(Request $request): JsonResponse
  {
    ...
    try {
      $response = Taxnonmy::getList($request);
    } catch (\Exception $e) {
      $response = [];
      $response['success'] = false;
  ...
  public function updateList(Request $request): JsonResponse
  {
    ...
    try {
      $response = Taxnonmy::updateList($request);
    } catch (\Exception $e) {
      $response = [];
      $response['success'] = false;
  ...
  public function listAction(Request $request, $type): JsonResponse
  {
    ...
    try {
      $response = Taxnonmy::listAction($request, $type);
    } catch (\Exception $e) {
      $response = [];
      $response['success'] = false;
  ...
  public function deleteList(Request $request): JsonResponse
  {
    ...
    try {
      $response = Taxnonmy::deleteList($request);
    } catch (\Exception $e) {
      $response = [];
      $response['success'] = false;
  ...
  public function createItem(Request $request): JsonResponse
  {
    ...
    try {
      $response = Taxnonmy::createItem($request);
    } catch (\Exception $e) {
      $response = [];
      $response['success'] = false;
  ...
  public function getListByTypeId(Request $request, $id): JsonResponse
  {
      ...
      try {
          $list = Taxnonmy::where('vh_taxonmies_shivang_id',$id)
              ->select('id','name','slug','vh_taxonmies_shivang_id')->get();
  ...
  public function updateItem(Request $request, $id): JsonResponse
  {
    ...
    try {
      $response = Taxnonmy::updateItem($request, $id);
    } catch (\Exception $e) {
      $response = [];
      $response['success'] = false;
  ...
  public function deleteItem(Request $request, $id): JsonResponse
  {
    ...
    try {
      $response = Taxnonmy::deleteItem($request, $id);
    } catch (\Exception $e) {
      $response = [];
      $response['success'] = false;
  ...
  public function itemAction(Request $request, $id, $action): JsonResponse
  {
    ...
    try {
      $response = Taxnonmy::itemAction($request, $id, $action);
    } catch (\Exception $e) {
      $response = [];
      $response['success'] = false;
  ...
  public function getParents(Request $request, $id, $name=null): array
  {
    $list = Taxnonmy::query()
      ...
      })->where('vh_taxonmies_shivang_id', $id)
      ->whereNotNull('is_active')
      ->take(10)
  ...
  {
    try {
      $response = Taxnonmy::query()->find($id);
    } catch (\Exception $e) {
      $response = [];
      $response['success'] = false;
