...
class Taxnonmy extends TaxonomyBase
{
  protected $table = 'vh_taxonmies_shivang';

  protected $fillable = [
    'uuid','parent_id','vh_taxonmies_shivang_id',
  ...
  public static function validation($inputs)
  {
      ...
      $rules = array(
          'vh_taxonmies_shivang_id' => 'required|exists:vh_taxonmies_type_shivang,id',
